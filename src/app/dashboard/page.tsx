          ...
          <div className="bg-white rounded-lg shadow px-5 py-6 sm:px-6">
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
                ...
                <div className="px-4 py-5 sm:p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        <dt className="text-sm font-medium text-gray-500 truncate">Content Created</dt>
                        <dd>
                          <div className="text-lg font-medium text-gray-900">{stats.contentCreated}</div>
                        </dd>
                      </dl>
                    </div>
                  </div>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd>
                          <div className="text-lg font-medium text-gray-900">${stats.earnings.toFixed(2)}</div>
                        </dd>
                      </dl>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 px-4 py-4 sm:px-6">
                  <div className="text-sm">
                    <a href="/affiliate" className="font-medium text-indigo-600 hover:text-indigo-500">
                      View details<span className="sr-only"> earnings</span>
                    </a>
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd>
                          <div className="text-lg font-medium text-gray-900">{stats.engagement}%</div>
                        </dd>
                      </dl>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 px-4 py-4 sm:px-6">
                  <div className="text-sm">
                    <a href="/analytics" className="font-medium text-indigo-600 hover:text-indigo-500">
                      View analytics<span className="sr-only"> engagement</span>
                    </a>
                  </div>
                </div>
              </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-5 w-0 flex-1">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          Generate content for multiple platforms with AI.
                        </p>
                      </div>
                    </div>
                    <div className="mt-4">
                ...
                <div className="bg-white overflow-hidden shadow rounded-lg">
                  <div className="px-4 py-5 sm:p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-5 w-0 flex-1">
                        <h3 className="text-lg font-medium text-gray-900">Manage Affiliates</h3>
                        <p className="mt-1 text-sm text-gray-500">
                          Set up and track affiliate links and earnings.
                        </p>
                      </div>
                    </div>
                    <div className="mt-4">
